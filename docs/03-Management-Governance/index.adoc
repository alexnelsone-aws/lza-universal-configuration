...
For detailed information on implementing and managing Control Tower Regional Deny controls, refer to the link:../07-Operations/07-06-Control-Tower-Regional-Deny.adoc[Control Tower Regional Deny Operations Guide].
